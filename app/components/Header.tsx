        ...
        <div className="w-full relative">
          ...
          <div className="hidden md:flex justify-center">
            ...
            >
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    key={item.path}
                    href={item.path}
                    className={`text-[11px] sm:text-[12px] md:text-[14px] lg:text-[14px] font-normal tracking-wide hover:opacity-60 transition-opacity py-2 whitespace-nowrap ${
                      isActive
              ...
              <Link
                href="/cart"
                className="text-[11px] sm:text-[12px] md:text-[14px] lg:text-[14px] font-normal tracking-wide hover:opacity-60 transition-opacity py-2 text-[#2d2d2d] flex items-center gap-1 whitespace-nowrap"
                style={{ fontFamily: "Avenir, 'Avenir Next', Montserrat, 'Century Gothic', 'Helvetica Neue', Arial, sans-serif" }}
              >
