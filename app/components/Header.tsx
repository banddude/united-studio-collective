        ...
        <div className="w-full relative">
          ...
          <div className="hidden min-[900px]:flex justify-center">
            ...
            >
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    key={item.path}
                    href={item.path}
                    className={`text-[12px] min-[700px]:text-[18px] font-normal tracking-wide hover:opacity-60 transition-opacity py-2 whitespace-nowrap ${
                      isActive
              ...
              <Link
                href="/cart"
                className="text-[12px] min-[700px]:text-[18px] font-normal tracking-wide hover:opacity-60 transition-opacity py-2 text-[#2d2d2d] flex items-center gap-1 whitespace-nowrap"
                style={{ fontFamily: "Avenir, 'Avenir Next', Montserrat, 'Century Gothic', 'Helvetica Neue', Arial, sans-serif" }}
              >
